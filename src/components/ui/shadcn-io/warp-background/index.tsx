...
export const WarpBackground: React.FC<WarpBackgroundProps> = ({
  ...
  return (
    <div className={cn("relative rounded border p-20 overflow-hidden", className)} {...props}>
      <div
        style={
          {
        ...
        className={
          "pointer-events-none absolute inset-0 overflow-hidden rounded-[inherit] [container-type:size] [perspective:var(--perspective)] [transform-style:preserve-3d]"
        }
      >
        {/* top side */}
