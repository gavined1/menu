    ...
    >
      ...
      <section className="pt-36 pb-24 md:pt-44 md:pb-32 px-6 overflow-hidden relative">
        <div className="max-w-5xl mx-auto text-center animate-fade-in">
          ...
          <p
            className={`text-lg mb-12 max-w-2xl mx-auto font-normal leading-relaxed ${isDark ? 'text-slate-400' : 'text-slate-600'
              }`}
          >
      ...
      <section id="features" className="py-28 relative">
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="mb-16">
            ...
            <p
              className={`text-sm max-w-md ${isDark ? 'text-slate-400' : 'text-slate-600'
                }`}
            >
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            >
              <div className="relative z-10">
                ...
                <p
                  className={`text-sm leading-relaxed max-w-sm ${isDark ? 'text-slate-400' : 'text-slate-600'
                    }`}
                >
              ...
              {/* Decorative Element */}
              <div
                className={`absolute -right-10 -bottom-10 w-64 h-64 rounded-full blur-3xl pointer-events-none ${isDark
      ...
      <section className="pt-28 pb-32 px-6 relative">
        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <p
            className={`text-lg mb-10 font-normal ${isDark ? 'text-slate-400' : 'text-slate-600'
              }`}
          >
          ...
          <p
            className={`text-xs mt-6 ${isDark ? 'text-slate-500' : 'text-slate-400'
              }`}
          >
